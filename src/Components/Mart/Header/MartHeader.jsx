...
<div className="text-center group">
  <div className="inline-flex flex-col items-center justify-center leading-none transform transition-all duration-300 group-hover:scale-[1.02] cursor-pointer">
    <div className="flex items-center space-x-2">
      ...
      <Sparkles className="ml-1 h-4 w-4 text-yellow-300 animate-pulse group-hover:animate-spin group-hover:duration-1000" />
    </div>

    {/* Very close subtitle, tight spacing */}
    <span className="text-[11px] sm:text-xs text-amber-100 italic tracking-wide">
      into sustainability
    </span>
  </div>
</div>
            ...
            <div className="hidden md:flex items-center space-x-7">
              ...
              >
                <div className="relative transform transition-transform duration-300 hover:scale-110">
                  ...
                  <span
                    className={`absolute -top-1.5 -right-1.5 bg-gradient-to-r from-orange-400 to-red-500 text-white text-[10px] rounded-full h-[18px] w-[18px] flex items-center justify-center font-bold transition-all duration-300 ${
            ...
            <div className="md:hidden flex items-center space-x-4">
              ...
              >
                ...
                <span
                  className={`absolute -top-1 -right-1 bg-gradient-to-r from-orange-400 to-red-500 text-white text-[10px] rounded-full h-[18px] w-[18px] flex items-center justify-center font-bold ${
        ...
        <div
          className={`md:hidden bg-red-800 overflow-hidden transition-all duration-500 ease-[cubic-bezier(0.68,-0.55,0.265,1.55)] ${
          ...
          <div className="px-5 py-2.5">
            <div className="flex justify-center">
              {navigationItems.map((item, index) => (
                <button
                  key={index}
                  className="text-white hover:text-yellow-200 hover:bg-red-800/40 px-5 py-2 text-[13px] font-medium transition-all duration-300 border-r border-red-700/20 last:border-r-0 relative group overflow-hidden"
                >
        ...
        <div
          className={`md:hidden bg-gradient-to-b from-red-800 to-red-900 overflow-hidden transition-all duration-500 ease-[cubic-bezier(0.68,-0.55,0.265,1.55)] ${
        ...
        >
          <div className="px-4 py-3 space-y-2">
            {navigationItems.map((item, index) => (
              <button
                key={index}
                className="block w-full text-left text-white hover:bg-red-700/40 px-4 py-3 rounded-md text-[16px] transition-all duration-300 flex items-center space-x-3.5 hover:pl-6 transform hover:scale-[1.02]"
              >
            ...
            {/* Extra Buttons */}
            <button className="block w-full text-left text-white hover:bg-red-700/40 px-4 py-3 rounded-md text-[16px] transition-all duration-300 flex items-center space-x-3.5 hover:pl-6 transform hover:scale-[1.02]">
