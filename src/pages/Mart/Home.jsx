...
const Home = () => {
  ...
  {
    name: "Tools",
    icon: ToolsIcon,         // Replace with your actual Tools icon import
    count: "200+",
...
const featuredProducts = [
  {
    ...
    reviews: 85,
    image:
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQSXkbAE4Lz8hpD3ksW8kgpwrMjkMoPi12IuA&s",
    discount: "20% OFF",
  },
  {
    id: 2,
  ...
  >
    {categories.map((cat, index) => (
      <div
        ...
        `}
      >
        <img src={cat.icon} alt={cat.name} className="w-8 h-8 mb-2" />
        <h4 className="text-md font-semibold">{cat.name}</h4>
        <span className="text-xs">{cat.count} items</span>
      </div>
    ))}
  </div>
</div>
      ...
      {/* Featured Products */}
      <div className="py-12 sm:py-16 bg-gradient-to-r from-gray-50 to-white">
        ...
        >
          <div className="relative overflow-hidden aspect-square">
            <img
              ...
              loading="lazy"
            />
            <div className="absolute top-2 right-2 bg-red-500 text-white px-2 py-1 rounded-full text-xs sm:text-sm font-semibold">
              {product.discount}
            </div>
          </div>
          <div className="p-4 sm:p-6">
            ...
            <button className="w-full bg-gradient-to-r from-red-600 to-orange-600 text-white py-2 sm:py-3 rounded-lg font-semibold hover:from-red-700 hover:to-orange-700 transition-all duration-300 flex items-center justify-center text-sm sm:text-base">
